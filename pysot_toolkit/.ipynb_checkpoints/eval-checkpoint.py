...
from pysot_toolkit.toolkit.datasets import GOT10kDataset,OTBDataset, UAVDataset, LaSOTDataset, VOTDataset, NFSDataset, VOTLTDataset
...
def main():
    ...
    tracker_dir = os.path.join(args.tracker_path,"LaSOT")
    ...
    root="/root/autodl-tmp/GOT-10k/test"
