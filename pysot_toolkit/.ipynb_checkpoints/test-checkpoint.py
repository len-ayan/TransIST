...
def main():
    ...
    dataset_root = '/root/autodl-tmp/GOT-10k/test4/test' #Absolute path of the dataset
    net_path = '/root/autodl-tmp/TransT/pytracking/networks/TransT_ep0120.pth.tar' #Absolute path of the model
    #net_path = '/root/autodl-tmp/TransT/pytracking/networks/transt1.pth'
    # create model
